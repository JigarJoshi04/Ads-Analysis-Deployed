                            ...
                            "$concat": [
                                {
                                    "$cond": [
                                        {
                                            "$and": [
                                                {"$gte": ["$monthly_income", 10]},
                                                {"$lt": ["$monthly_income", 20]},
                                            ]
                                        },
                                        "10 - 20k",
                                        "",
                                ...
                                },
                                {
                                    "$cond": [
                                        {
                                            "$and": [
                                                {"$gte": ["$monthly_income", 20]},
                                                {"$lt": ["$monthly_income", 40]},
                                            ]
                                        },
                                        "20 - 40k",
                                        "",
                                ...
                                },
                                {
                                    "$cond": [
                                        {
                                            "$and": [
                                                {"$gte": ["$monthly_income", 40]},
                                                {"$lt": ["$monthly_income", 60]},
                                            ]
                                        },
                                        "40 - 60k",
                                        "",
                                ...
                                },
                                {
                                    "$cond": [
                                        {
                                            "$and": [
                                                {"$gte": ["$monthly_income", 60]},
                                                {"$lt": ["$monthly_income", 80]},
                                            ]
                                        },
                                        "60 - 80k",
                                        "",
                                ...
                                },
                                {
                                    "$cond": [
                                        {
                                            "$and": [
                                                {"$gte": ["$monthly_income", 80]},
                                                {"$lt": ["$monthly_income", 100]},
                                            ]
                                        },
                                        "80 - 100k",
                                        "",
                                ...
                                },
                                {
                                    "$cond": [
                                        {
                                            "$and": [
                                                {"$gte": ["$monthly_income", 100]},
                                                {"$lt": ["$monthly_income", 201]},
                                            ]
                                        },
                                        "100 - 200k",
                                        "",
